...
df2 = pd.DataFrame({'Rext (ohm)':[92,47,22,10,6.8,5.6,4.7,3.3,
                                  2.2,1.8,1.2,0.56, 0.39,0.22,0.1,0.000001]})
...
#Gráficos
plt.plot(df2["I (A)"], df2["E (V)"], color= "g", label= '*Rext')
plt.title('E vs I')
plt.xlabel('I (A)')
plt.ylabel('E (V)')
...
plt.legend(loc='upper right', 
          ncol=2, fancybox=True, shadow=True)
#Gráfico3
plt.plot(df2["I (A/m2)"], df2["P (W/m2)"], 'r', label= 'P vs I')
plt.title('P vs I')
plt.xlabel('I (A/m2)')
plt.ylabel('P (W/m2)')
plt.legend(loc='upper right', 
